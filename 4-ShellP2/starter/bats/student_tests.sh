...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="/home/erg69/CS283/4-ShellP2/starter/bats/dsh-testdsh2>dsh2>dsh2>cmdloopreturned0"
...
EOF
    ...
    # Expected output with all whitespace removed for easier matching
    expected_output="dsh2>error:Executabletoolongdsh2>cmdloopreturned0"
